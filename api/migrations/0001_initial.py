# Generated by Django 5.0.4 on 2024-05-29 10:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caregiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='caregiver_appointments', to='api.user')),
                ('senior', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='senior_appointments', to='api.user')),
            ],
        ),
    ]
